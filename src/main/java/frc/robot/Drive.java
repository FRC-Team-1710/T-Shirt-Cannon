...
public static VictorSPX R1, R2, L1, L2;
static boolean navxReset = false;
static double setPoint;
static double lastAngle, angleIntegral, output;

public static void initializeDrive () {
	R1 = new VictorSPX (Constants.rightFollowerid);
       R2 = new VictorSPX (Constants.rightFollowerid2);

	L1 = new VictorSPX (Constants.leftFollowerid);
	L2 = new VictorSPX (Constants.leftFollowerid2);
